...
// update_theta
List update_theta(int N_iter, NumericMatrix dd, int n, arma::vec m0, arma::mat L0, arma::mat S0, double v0, double time_max, arma::mat init_Sigma);
RcppExport SEXP _BayesianWinRatio_update_theta(SEXP N_iterSEXP, SEXP ddSEXP, SEXP nSEXP, SEXP m0SEXP, SEXP L0SEXP, SEXP S0SEXP, SEXP v0SEXP, SEXP time_maxSEXP, SEXP init_SigmaSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::mat >::type init_Sigma(init_SigmaSEXP);
    rcpp_result_gen = Rcpp::wrap(update_theta(N_iter, dd, n, m0, L0, S0, v0, time_max, init_Sigma));
    return rcpp_result_gen;
END_RCPP
}
// update_theta_univariate
List update_theta_univariate(int N_iter, NumericMatrix dd, int n, double L0, double m0, double v0, double S0, double time_max, double init_Sigma);
RcppExport SEXP _BayesianWinRatio_update_theta_univariate(SEXP N_iterSEXP, SEXP ddSEXP, SEXP nSEXP, SEXP L0SEXP, SEXP m0SEXP, SEXP v0SEXP, SEXP S0SEXP, SEXP time_maxSEXP, SEXP init_SigmaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type N_iter(N_iterSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(update_theta_univariate(N_iter, dd, n, L0, m0, v0, S0, time_max, init_Sigma));
    return rcpp_result_gen;
END_RCPP
}
// compare
...
static const R_CallMethodDef CallEntries[] = {
    {"_BayesianWinRatio_update_theta", (DL_FUNC) &_BayesianWinRatio_update_theta, 9},
    {"_BayesianWinRatio_update_theta_univariate", (DL_FUNC) &_BayesianWinRatio_update_theta_univariate, 9},
